...
<div class="df-card">
    ...
    <div class="df-card-body">
        <form action="{{ route('admin.testimonials.store') }}" method="POST" class="row g-4">
            @csrf
            <div class="col-md-6">
                <label class="df-form-label">Customer Name <span class="text-danger">*</span></label>
                <input type="text" name="name" class="df-form-control" value="{{ old('name') }}" required>
            </div>
            <div class="col-md-6">
                <label class="df-form-label">Initials (optional)</label>
                <input type="text" name="initials" class="df-form-control" value="{{ old('initials') }}" maxlength="8" placeholder="Auto from name if blank">
            </div>
            <div class="col-md-8">
                <label class="df-form-label">Designation / Location</label>
                <input type="text" name="designation" class="df-form-control" value="{{ old('designation') }}" placeholder="e.g. Fitness Enthusiast, Delhi">
            </div>
            <div class="col-md-2">
                <label class="df-form-label">Rating <span class="text-danger">*</span></label>
                <input type="number" min="0" max="5" step="0.5" name="rating" class="df-form-control" value="{{ old('rating', 5) }}" required>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-12">
                ...
                <textarea name="content" rows="5" class="df-form-control" required>{{ old('content') }}</textarea>
            </div>
            <div class="col-12">
            ...
            <div class="col-12 d-flex gap-2">
                <button type="submit" class="df-btn df-btn-primary"><i class="bi bi-check2-circle"></i> Save Testimonial</button>
