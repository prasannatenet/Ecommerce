...
<div class="df-card">
    ...
    <div class="df-card-body">
        <form action="{{ route('admin.faqs.store') }}" method="POST" class="row g-4">
            @csrf
            <div class="col-md-8">
                <label class="df-form-label">Question <span class="text-danger">*</span></label>
                <input type="text" name="question" class="df-form-control" value="{{ old('question') }}" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-12">
                ...
                <textarea name="answer" rows="5" class="df-form-control" required>{{ old('answer') }}</textarea>
            </div>
            <div class="col-12">
            ...
            <div class="col-12 d-flex gap-2">
                <button type="submit" class="df-btn df-btn-primary"><i class="bi bi-check2-circle"></i> Save FAQ</button>
