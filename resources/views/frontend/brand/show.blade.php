...
@section('content')
    ...
    <section
        style="border: solid 1px #ccc; box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px; margin-bottom: 3px;">
        ...
        <div class="container">
            ...
            @empty
                <div
                    ...
                    <h3 style="font-size:1.2rem; font-weight:800; color:#0D0D0D; margin-bottom:8px; text-transform:uppercase;">
                        No
                        Products Found</h3>
                    <p style="color:#6C757D; font-size:0.9rem; margin-bottom:24px;">There are currently no products available
                        from
                        this brand.</p>
